...
export function ReceiptModal({ isOpen, onClose, data }: ReceiptModalProps) {
  ...
  return (
    <Modal
      ...
      description="Xem trước phiếu thu, tải ảnh hoặc copy để gửi cho khách trọ"
    >
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-2 bg-slate-50 p-2.5 rounded-2xl border border-slate-200/80">
          <Button
            ...
            className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs gap-1.5 h-10 shadow-sm"
          >
          ...
          <Button
            ...
            className="w-full font-bold text-xs gap-1.5 h-10 text-slate-700 border-slate-300 hover:bg-white"
          >
            {copiedImage ? (
              <>
