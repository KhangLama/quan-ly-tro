...
export function EditTenantModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (res.success) {
      ...
      setError(res.error || "Có lỗi xảy ra khi cập nhật thông tin khách thuê");
    }
  };
    ...
    <Modal
      ...
      title={
        <div className="flex items-center gap-2">
          ...
          <span>Sửa thông tin khách thuê</span>
        </div>
      }
      description={`Cập nhật thông tin cho khách thuê ${tenant.name}`}
    >
